...
hsp = sc.textFile("file:///home/corrado/Scrivania/bd_project/Datasets/Original/historical_stock_prices.csv") \
...
hs = sc.textFile("file:///home/corrado/Scrivania/bd_project/Datasets/Original/historical_stocks.csv") \
 	   .map(lambda linea: parse_linea(linea)) \
 	   .filter(lambda linea: linea[0] != "ticker") \
...
#restitusco (nome, anno),somma dei close
...
join_variazione_percentuale = data_close_minimo \
...
tripletta_trend = variazione_percentuale \
...
tripletta_trend_pulito_ordinato = tripletta_trend_pulito \
...
output.coalesce(1).saveAsTextFile("file:///home/corrado/Scrivania/bd_project/Job3/Spark/output_job3/")
