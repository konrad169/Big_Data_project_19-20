...
input = sc.textFile("file:///home/corrado/Scrivania/bd_project/Datasets/Original/historical_stock_prices.csv") \
...
sc.parallelize(output).coalesce(1) \
					  .saveAsTextFile("file:///home/corrado/Scrivania/bd_project/Job1/Spark/output_job1/")
